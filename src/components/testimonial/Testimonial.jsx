    ...
    <div>
        <section className=''>
            <div className='container mx-auto px-5 py-10'>
                ...
                <h2 className='text-center text-2xl font-semibold mb-10' style={{color: mode ==='dark' ?'white' :''}}>What our <span className='text-purple-800'>customers</span> are saying</h2>
